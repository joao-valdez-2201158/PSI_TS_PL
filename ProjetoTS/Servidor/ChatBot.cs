...
namespace Servidor
{
    ...
    public class ChatBot
    {
        ...
        public string ReadText(string TextBox_Text)
        {
            ...
            else if (TextBox_Text == "Data?" || TextBox_Text == "data?" || TextBox_Text == "Data de hoje?" || TextBox_Text == "data de hoje?")
            {
                str = "A Data é a seguinte: " + DateTime.Now.ToString("D");
            }
            else if (TextBox_Text == "Como estas?" || TextBox_Text == "como estas?" || TextBox_Text == "Como estás?" || TextBox_Text == "como estás?")
            {
            ...
            else if (TextBox_Text == "Adeus" || TextBox_Text == "adeus" || TextBox_Text == "xau" || TextBox_Text == "tchau")
            {
                str = "Adeus, Fique bem!";
            }
            else
